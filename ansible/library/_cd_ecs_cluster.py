...
DOCUMENTATION = '''
---
module: cd_ecs_cluster
short_description: creates ecs cluster.
description:
...
def main():
    ...
    argument_spec.update(dict(
      ...
      rep=dict(required=False, default=None, type='list'),
      repeat=dict(required=False, default=None, type='int'),
      delay=dict(required=False, default=None, type='int')
      )
    )
