...
def sb_lambda_update(module, client, function_name, layers=None, file_config=None, image_config=None):
    pName = function_name
    found = True
    if layers:
...
def main():
    ...
    typeList, changed = sb_lambda_update(module, client, function_name, layers, file_config, image_config)
